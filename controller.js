...
//ruiny controllers
    app.controller("r_k_s", function($scope, $routeParams){
    ...
    app.controller("r_k_n", function($scope, $routeParams){
    ...
    app.controller("r_s_s", function($scope, $routeParams){
    ...
    app.controller("r_s_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
    ...
    app.controller("r_d_s", function($scope, $routeParams){
    ...
    app.controller("r_d_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
...
//norowisko controllers
    app.controller("n_k_s", function($scope, $routeParams){
    ...
    app.controller("n_k_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=16;
                var c=$scope.ekw_lopata=2;
                var d=$scope.ekw_woda_swiecona=2;
    ...
    app.controller("n_s_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=16;
                var b=$scope.ekw_jedzenie=18;
                var c=$scope.ekw_lopata=3;
                var d=$scope.ekw_woda_swiecona=3;
    ...
    app.controller("n_s_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=22;
                var c=$scope.ekw_lopata=3;
                var d=$scope.ekw_woda_swiecona=3;
    ...
    app.controller("n_d_s", function($scope, $routeParams){
    ...
    app.controller("n_d_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=24;
                var c=$scope.ekw_lopata=4;
                var d=$scope.ekw_woda_swiecona=4;
...
//knieja controllers
    app.controller("k_k_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=8;
                var b=$scope.ekw_jedzenie=12;
                var c=$scope.ekw_lopata=3;
    ...
    app.controller("k_k_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=16;
                var c=$scope.ekw_lopata=3;
                var d=$scope.ekw_woda_swiecona=2;
    ...
    app.controller("k_s_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=13;
                var b=$scope.ekw_jedzenie=18;
    ...
    app.controller("k_s_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=22;
                var c=$scope.ekw_lopata=5;
                var d=$scope.ekw_woda_swiecona=3;
    ...
    app.controller("k_d_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=16;
                var b=$scope.ekw_jedzenie=20;
    ...
    app.controller("k_d_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=24;
                var c=$scope.ekw_lopata=6;
                var d=$scope.ekw_woda_swiecona=3;
...
//zatoka controllers
    app.controller("z_k_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=8;
                var b=$scope.ekw_jedzenie=12;
                var c=$scope.ekw_lopata=3;
    ...
    app.controller("z_k_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=16;
                var c=$scope.ekw_lopata=3;
                var d=$scope.ekw_woda_swiecona=1;
    ...
    app.controller("z_s_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=13;
                var b=$scope.ekw_jedzenie=18;
                var c=$scope.ekw_lopata=5;
                var d=$scope.ekw_woda_swiecona=2;
    ...
    app.controller("z_s_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=24;
                var c=$scope.ekw_lopata=5;
                var d=$scope.ekw_woda_swiecona=2;
    ...
    app.controller("z_d_s", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=16;
                var b=$scope.ekw_jedzenie=20;
                var c=$scope.ekw_lopata=6;
                var d=$scope.ekw_woda_swiecona=1;
    ...
    app.controller("z_d_n", function($scope, $routeParams){
                var a=$scope.ekw_pochodnia=0;
                var b=$scope.ekw_jedzenie=24;
                var c=$scope.ekw_lopata=6;
                var d=$scope.ekw_woda_swiecona=2;
